...
public class GoogleDrive extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_home:
                ...
                startActivity(new Intent(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.this, MainActivity.class));
                break;
            case R.id.nav_location:
                finish();
                startActivity(new Intent(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.this, LocationSetActivity.class));
            ...
            case R.id.nav_sns:
                ...
                if (isLoggedIn) {
                    startActivity(new Intent(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.this, InstagramLoggedInActivity.class));
                } else {
                    startActivity(new Intent(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.this, MediaSetActivity.class));
                }
                break;
            case R.id.nav_photos:
                finish();
                startActivity(new Intent(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.this, CapturedPhotosActivity.class));
            ...
            case R.id.nav_smartwatch:
                startActivity(new Intent(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.this, SmartwatchActivity.class));
            ...
            case R.id.nav_restart:
                ...
                if (!Tools.hasPermissions(this, Tools.PERMISSIONS)) {
                    runOnUiThread(() -> dialog = Tools.requestPermissions(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.this));
                } else {
            ...
            case R.id.nav_logout:
                ...
                alertDialog.setPositiveButton(
                        getString(R.string.yes), (dialog, which) -> {
                            ...
                            stopService(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.customSensorsService);
                            finish();
                        });
    ...
    public void upload(View view) {
        ...
        if (Tools.isNetworkAvailable()) {
            ...
            driveServiceHelper.createDBFile(com.nematjon.edd_client_season_two.drive_upload.GoogleDrive.this, filePath.getPath()).addOnSuccessListener(s -> {
